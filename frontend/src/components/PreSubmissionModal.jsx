      ...
      <div className="pre-submission-modal" role="dialog" aria-modal="true" aria-labelledby="pre-submission-title">
        ...
        <div className="pre-submission-content">
          {step === 1 && <>
            ...
            <fieldset className="pre-submission-field"><legend>Is the partner institution local, international, or Ddepartmental?</legend><OptionGroup name="partnerClassification" value={answers.partnerClassification} onChange={update} options={[["local", "Local"], ["international", "International"], ["Departmental", "Departmental"]]} disabled={loading} /></fieldset>
          </>}
